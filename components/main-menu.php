...
<nav class="first-part">
    <ul>
        ...
        <li id="<?php echo $current_user_placement == 'wall' ? 'active' : '' ?>"><a href="/wall">
        ...
        <li id="<?php echo $current_user_placement == 'case' ? 'active' : '' ?>"><a href="/case"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
