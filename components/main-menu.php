...
<script id="menu-script" src="<?= $global_url ?>/js/main.js?v=300before" data-who_is_me="<?= $current_user_id ?>"></script>
<script src="<?= $global_url ?>/js/main-menu.js?v=300before"></script>