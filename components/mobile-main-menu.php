...
<nav class="first-part-mobile">
    ...
    <a href="/profile" class="menu__link-profile" id="<?php echo $current_user_placement == 'profile' ? 'active' : '' ?>">
        <img class="menu-avatar" src="/uploads/avatar/thin_<?= $current_user_avatar ?>">
        <?php if ($current_user_verify_status) { ?>
            <img class='mobile-menu-status' src="/pics/SuperUserIcon.svg">
        <?php } else {
            switch ($current_user_in_top) {
                case 1:
                    echo "<img class='mobile-menu-status' src='/pics/BlossomFirstIcon.svg'>";
                    break;
                case 2:
                    echo "<img class='mobile-menu-status' src='/pics/BlossomSecondIcon.svg'>";
                    break;
                case 3:
                    echo "<img class='mobile-menu-status' src='/pics/BlossomThirdIcon.svg'>";
                    break;
            }
        } ?>
