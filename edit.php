...
<head>
    ...
    <link rel="stylesheet" href="css/edit.css?v=200">
                ...
                <div class="third-part">
                    <div>
                        ...
                        <div class='edit-filter__choice'>
                            <label class="edit-filter-popup-li" id="edit-filter-top">Рейтинг<span>По уровню Цветения</span><input checked name="people-filter" type="radio" value=""></label>
                            <label class="edit-filter-popup-li" id="edit-filter-all">Все<span>Поиск пользователей</span><input name="people-filter" type="radio" value=""></label>
                        </div>
                    </div>
                </div>
            </section>
...
<script src="js/edit.js?v=200"></script>
</body>
