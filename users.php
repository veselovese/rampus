...
<head>
    ...
    <meta property="og:title" content="Рейтинг и поиск пользователей в Рампусе" />

    <meta property="og:site_name" content="Рампус">
    <meta property="og:url" content="<?= $baseUrl ?>/users">
                        ...
                        <div class="top-users">
                            <?php if ($result_top->num_rows > 0) {
                                ...
                                while ($row = $result_top->fetch_assoc()) {
                                    ...
                                    $other_user_verify_status = $row['verify_status'];
