...
<head>
    ...
    <link rel="stylesheet" href="../css/wall.css?v=310">
...
<script src="../js/wall.js?v=310"></script>
<script src="../js/comments-actions-current-post.js?v=310"></script>
<script src="../js/currentpost.js?v=310"></script>
</body>
