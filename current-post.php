...
<head>
    ...
    <link rel="stylesheet" href="../css/wall.css?v=302">
...
<script src="../js/wall.js?v=302"></script>
<script src="../js/comments-actions-current-post.js?v=302"></script>
<script src="../js/currentpost.js?v=302"></script>
</body>
