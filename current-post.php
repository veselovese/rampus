...
if ($current_post_id) {
    ...
    if ($postData) {
        ...
        $ogUrl = $baseUrl . "/post/" . $current_post_id;
    }
}
...
<?php
if (!isset($_SESSION['user'])) {
    header("Location: ../auth?r=post&id=$current_post_id");
    exit();
}
?>
...
<body>
    ...
    <script src="../js/comments-actions-current-post.js?v=320"></script>
    <script src="../js/currentpost.js?v=320"></script>
</body>
