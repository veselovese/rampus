                        ...
                        <div class="friends__users">
                            ...
                            <?php if ($result_request_to->num_rows > 0) {
                                ...
                                while ($row_request = $result_request_to->fetch_assoc()) {
                                    ...
                                    echo "<span class='answer-to-requests-popup-li' id='add-to-friends_$other_id' onclick='addToFriends($other_id, $id)'>Принять</span>";
                                    echo "<div class='div-line'></div>";
                                    echo "<span class='answer-to-requests-popup-li unrequest' id='unrequest-from-friends_$other_id' onclick='unrequestToFriends($other_id, $id)'>Отклонить</span>";
                                    echo "</div>";
                                    echo "</div>";
                                    echo "</li>";
                                    if ($counter > 0) {
