...
$ogTitle = "Профиль пользователя в Рампусе";
$ogDesc = "Перейдите, чтобы добавить в друзья, написать или посмотреть все посты и репосты";
$ogImage = $baseUrl . "/pics/plugs/RampusSmallPlug.png";
$ogUrl = $baseUrl;
...
if ($result_other_user->num_rows > 0) {
    ...
    $ogImage = $other_user_avatar != 'noavatar.jpg' ? $baseUrl . "/uploads/avatar/small_" . $other_user_avatar : $ogImage;
    $ogUrl = $baseUrl . "/user/" . $other_user_username;
} else {
...
if (isset($_SESSION['user'])) {
    ...
    require_once('backfiles/friends/get-friend-status.php');
...
(
    ...
    $sql_other_user_posts_and_likes_counter = "SELECT 
        ...
        SUM(p.views) AS other_user_views_counter
    FROM posts p
    ...
    if ($result_other_user_posts_and_likes_counter->num_rows > 0) {
        ...
        $other_user_views_counter = $row_other_user_posts_and_likes_counter["other_user_views_counter"];
    }
...
<?php
if (!isset($_SESSION['user'])) {
    header("Location: ../auth?r=user&id=$other_user_username");
    exit();
}
?>
...
<body>
                                ...
                                <div class="third-part-mobile">
                                    <div class="profile__counters">
                                        ...
                                        <div class="profile__counters-div">
                                            ...
                                            <div class="profile__posts">
                                                Просмотры
                                                <span> <?= $other_user_views_counter ?></span>
                                            </div>
                                            <div class="div-line"></div>
                                ...
                                <div>
                                    <fieldset class="show-user-posts-mode-fieldset" id="watch-user-posts-mode-fieldset">
                                        ...
                                        <div>
                                            ...
                                            <label for="show-other-posts" id="mode__show-posts">
                                                Посты</label>
                                        </div>
                                        <div>
                                            <input type="radio" id="show-other-reposts" name="watch-user-posts-mode-fieldset" value="show-reposts">
                                            <label for="show-other-reposts" id="mode__show-reposts">
                                                Репосты</label>
                                        </div>
                                    </fieldset>
                                </div>
    ...
    <script src="../js/otheruserprofile.js?v=330"></script>
